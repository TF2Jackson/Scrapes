...
sources = ['https://www.nytimes.com/','https://www.reuters.com/']
...
for i in sources:
    ...
    with open(f'Print_MSM_{today}.txt', 'a') as fo:
        fo.write(text)

    with open(f'Print_MSM_{today}.txt','r',errors='ignore') as fo1:
    ...
    for i in msm:
        ...
        for i in clean:
            with open(f'Print_MSM_{today}.csv', 'a') as fo2:
